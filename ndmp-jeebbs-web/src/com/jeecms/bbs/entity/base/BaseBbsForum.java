...
public abstract class BaseBbsForum implements Serializable {
	...
	private java.util.Set<com.jeecms.bbs.entity.BbsTopic> topics;
	...
	public java.util.Set<com.jeecms.bbs.entity.BbsTopic> getTopics() {
		return topics;
	}

	public void setTopics(java.util.Set<com.jeecms.bbs.entity.BbsTopic> topics) {
		this.topics = topics;
	}
